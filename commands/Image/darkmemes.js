...
module.exports ={
    execute: async(bot, message, args) => {
        ...
        if(!message.channel.nsfw){
            message.channel.send("This command can send NSFW memes please use this command in a NSFW channel")
        }else{
            let MEME = [
            'https://www.reddit.com/r/fuckedupmemes2/random/.json',
            'https://www.reddit.com/r/darkmemers/random/.json',
            ]
    ...
    name:"darkmeme",
    aliases: ["d_meme","Dmeme"],
    description: 'Sends dark memes',
    usage:""
}